...
namespace TestyJednostkowe
{
    ...
    public class UnitTest1
    {
        ...
        public static void CreateDB(TestContext testContext)
        {
            ...
            context.Odczyny.Add(new Odczyny { Id = 5, Nazwa = "Senno��" });
            ...
            context.AtrybutyOdczynow.Add(new AtrybutyOdczynow { Id = 2, OdczynId = 2, Typ = 1, Nazwa = "Stopie�", Info = "Lekki;�redni;Silny" });
