  ...
  function CustomNoRowsOverlay() {
    ...
    return (
      <GridOverlay className={classes.root}>
        ...
        <div className={classes.label}>Brak Zgłoszeń</div>
      </GridOverlay>
    );
  }
...
const rows = [
    { id: 1, nazwa_Szczepionki: 'Menuvo', lekkie: '30',powazne:'40', ciezkie: '50' },
    { id: 2, nazwa_Szczepionki: 'Aether', lekkie: '1',powazne:'4', ciezkie: '2' },
  ...
  const classes = useStyles();
    return(
        <div style={{ height: 600, width: '100%' }} className={classes.root}>
            <DataGrid rows={rows} columns={columns} pagination showToolbar  pageSize={10} filterModel={riceFilterModel} components={{
...
export default PzhVaccinesList;
